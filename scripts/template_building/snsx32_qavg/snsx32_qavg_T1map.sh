#!/bin/bash
# resample all original T1map images into template space
# how to run on graham: regularInteractive --> neurogliaShell --> cd /project/6007967/jclau/snsx32/sandbox/
#   then: ~/GitHub/snsx32/scripts/template_building/snsx32_qavg/snsx32_qavg_T1map.sh -i ~/GitHub/snsx32/input/input_csv/snsx32.csv
...
while read SUBJ; do
  ...
  echo $SUBJ
  echo "---------"
  input_qmap=${input_dir}/${SUBJ}/anat/${SUBJ}_acq-MP2RAGE_run-01_T1map.nii.gz
  output_qmap=${output_dir}/${SUBJ}/anat/${SUBJ}_acq-MP2RAGE_space-template_T1map.nii.gz
  output_qmap_700iso=${output_dir}/${SUBJ}/anat/${SUBJ}_acq-MP2RAGE_space-template_res-700iso_T1map.nii.gz
...
echo AverageImages 3 $output_dir/snsx32_v0.1_i09_avg_T1map.nii.gz 0 `find $output_dir/ -name '*space-template_T1map.nii.gz' | sort`
AverageImages 3 $output_dir/snsx32_v0.1_i09_avg_T1map.nii.gz 0 `find $output_dir/ -name '*space-template_T1map.nii.gz' | sort`
echo ImageMath 3 $output_dir/snsx32_v0.1_i09_avg_sharpened_T1map.nii.gz Sharpen $output_dir/snsx32_v0.1_i09_avg_T1map.nii.gz
ImageMath 3 $output_dir/snsx32_v0.1_i09_avg_sharpened_T1map.nii.gz Sharpen $output_dir/snsx32_v0.1_i09_avg_T1map.nii.gz

# template in 0.7 mm
echo AverageImages 3 $output_dir/snsx32_v0.1_i09_avg_T1map_700iso.nii.gz 0 `find $output_dir/ -name '*space-template_res-700iso_T1map.nii.gz' | sort`
AverageImages 3 $output_dir/snsx32_v0.1_i09_avg_T1map_700iso.nii.gz 0 `find $output_dir/ -name '*space-template_res-700iso_T1map.nii.gz' | sort`
echo ImageMath 3 $output_dir/snsx32_v0.1_i09_avg_sharpened_T1map_700iso.nii.gz Sharpen $output_dir/snsx32_v0.1_i09_avg_T1map_700iso.nii.gz
ImageMath 3 $output_dir/snsx32_v0.1_i09_avg_sharpened_T1map_700iso.nii.gz Sharpen $output_dir/snsx32_v0.1_i09_avg_T1map_700iso.nii.gz
