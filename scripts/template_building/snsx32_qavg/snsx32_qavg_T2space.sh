...
#   then: ~/GitHub/snsx32/scripts/template_building/snsx32_qavg/snsx32_qavg_T2space.sh -i ~/GitHub/snsx32/scripts/template_building/snsx32_qavg/snsx32_qavg_proc-prepT2_space-T1w_T2w_QCed.csv
...
echo AverageImages 3 $output_dir/snsx32_v0.1_i09_avg_T2w_inm.nii.gz 0 `find $output_dir/ -name '*space-template_T2w_inm.nii.gz' | sort`
AverageImages 3 $output_dir/snsx32_v0.1_i09_avg_T2w_inm.nii.gz 0 `find $output_dir/ -name '*space-template_T2w_inm.nii.gz' | sort`
echo ImageMath 3 $output_dir/snsx32_v0.1_i09_avg_sharpened_T2w_inm.nii.gz Sharpen $output_dir/snsx32_v0.1_i09_avg_T2w_inm.nii.gz
ImageMath 3 $output_dir/snsx32_v0.1_i09_avg_sharpened_T2w_inm.nii.gz Sharpen $output_dir/snsx32_v0.1_i09_avg_T2w_inm.nii.gz

# template in 0.7 mm
echo AverageImages 3 $output_dir/snsx32_v0.1_i09_avg_T2w_700iso_inm.nii.gz 0 `find $output_dir/ -name '*space-template_res-700iso_T2w_inm.nii.gz' | sort`
AverageImages 3 $output_dir/snsx32_v0.1_i09_avg_T2w_700iso_inm.nii.gz 0 `find $output_dir/ -name '*space-template_res-700iso_T2w_inm.nii.gz' | sort`
echo ImageMath 3 $output_dir/snsx32_v0.1_i09_avg_sharpened_T2w_700iso_inm.nii.gz Sharpen $output_dir/snsx32_v0.1_i09_avg_T2w_700iso_inm.nii.gz
ImageMath 3 $output_dir/snsx32_v0.1_i09_avg_sharpened_T2w_700iso_inm.nii.gz Sharpen $output_dir/snsx32_v0.1_i09_avg_T2w_700iso_inm.nii.gz
